 ...
 */
public class number19 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.number19);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.button1:
                ...
                Toast.makeText(this, "김영훈에게 전화중~",
                        Toast.LENGTH_SHORT).show();
                startActivity(intent1);
                break;
            case R.id.button2:
                Intent intent2 = new Intent(Intent.ACTION_SENDTO,
                        Uri.parse("smsto:01041648340"));
                intent2.putExtra("sms_body", "내용을 입력하세요.");
                Toast.makeText(this, "김영훈에게 문자를보냅니다.",
                        Toast.LENGTH_SHORT).show();
