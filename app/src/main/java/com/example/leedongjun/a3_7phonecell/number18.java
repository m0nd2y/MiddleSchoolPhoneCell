 ...
 */
public class number18 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.number18);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.button1:
                ...
                Toast.makeText(this, "김민혁에게 전화중~",
                        Toast.LENGTH_SHORT).show();
                startActivity(intent1);
                break;
            case R.id.button2:
                Intent intent2 = new Intent(Intent.ACTION_SENDTO,
                        Uri.parse("smsto:01039029952"));
                intent2.putExtra("sms_body", "내용을 입력하세요.");
                Toast.makeText(this, "김민혁에게 문자를보냅니다.",
                        Toast.LENGTH_SHORT).show();
