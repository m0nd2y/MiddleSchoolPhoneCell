 ...
 */
public class number33 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.number33);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.button2:
                ...
                Toast.makeText(this, "정재호에게 문자를보냅니다.",
                        Toast.LENGTH_SHORT).show();
